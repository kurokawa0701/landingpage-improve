...
function handleDownload(p) {
  ...
  try {
    ...
    const toBody     = [
      ...
      '東京都中央区築地2丁目12番10号',
      'ビルネット築地ビル 4 階 A',
      'TEL：03-6281-5088　/　FAX：03-6281-5447',
      '携帯電話番号：080-8398-7172',
      'kazuma.kurokawa@oneness-group.jp',
      'nbs-tokyo-sales@oneness-group.jp (営業共通)',
      'URL:https://www.neighborengineers.jp',
      '労働者派遣事業認可：派27-304862',
      'ISO/IEC 27001',
      '------------------------------------------------------------------'
    ].join('\n');
